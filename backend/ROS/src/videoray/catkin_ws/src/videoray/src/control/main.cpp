...
{     
     ...
     while (ros::ok()) {                   
          ...
          if (joystick_enabled_) {
               ...
               port_thrust_ = invert_sign(normalize(axis_[4], -32767, 32767, -89, 89));
               star_thrust_ = invert_sign(normalize(axis_[4], -32767, 32767, -89, 89));

               turn_ = invert_sign(normalize(axis_[3], -32767, 32767, -89, 89));
               port_thrust_ -= turn_;
               star_thrust_ += turn_;
...
/*                cout << "LEFT ANALOG H: " << axis_[0]<< endl;
               cout << "LEFT ANALOG V: " << invert_sign(axis_[1])<< endl;
               cout << "LEFT TRIGGER: " << axis_[2]<< endl;
               cout << "RIGHT ANALOG H: " << axis_[3]<< endl;     
               cout << "RIGHT ANALOG V: " << -axis_[4]<< endl;
               cout << "RIGHT TRIGGER: " << axis_[5]<< endl; */
          ...
          // cout << " PORTSIDE THRUSTER: " << port_thrust_ << endl;
          // cout << " STARBOARD THRUSTER: " << star_thrust_ << endl;
          // cout << " LIGHTS: " << lights_ << endl;     
          // cout << " TILT: " << tilt_ << endl;
