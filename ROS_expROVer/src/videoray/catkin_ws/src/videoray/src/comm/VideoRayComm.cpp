...
char enable_cam_menu[] =  {(char)0xCA,(char) 0x01};
char arrow_right_data[] = {(char)0xCA, (char)0x10};
char arrow_left_data[] = {(char)0xCA, (char)0x08};
char arrow_down_data[] = {(char)0xCA, (char)0x04};
char arrow_up_data[] = {(char)0xCA, (char)0x02};
