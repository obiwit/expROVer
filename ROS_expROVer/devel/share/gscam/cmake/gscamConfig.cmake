...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/pergunta/Desktop/PEI/humans/src/videoray/catkin_ws/src/gscam-master)
  set(gscam_DEVEL_PREFIX /home/pergunta/Desktop/PEI/humans/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/pergunta/Desktop/PEI/humans/install)
...
if(NOT "/home/pergunta/Desktop/PEI/humans/src/videoray/catkin_ws/src/gscam-master/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/pergunta/Desktop/PEI/humans/src/videoray/catkin_ws/src/gscam-master/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pergunta/Desktop/PEI/humans/src/videoray/catkin_ws/src/gscam-master/${idir}'.  ${_report}")
    endif()
